...
__data_args = {
    'ntu-xsub': {'class': 60, 'shape': [3, 4, 300, 14, 2], 'feeder': NTU_Feeder},
    'ntu-xview': {'class': 60, 'shape': [3, 4, 300, 14, 2], 'feeder': NTU_Feeder},
    'ntu-xsub120': {'class': 120, 'shape': [3, 4, 300, 14, 2], 'feeder': NTU_Feeder},
    'ntu-xset120': {'class': 120, 'shape': [3, 4, 300, 14, 2], 'feeder': NTU_Feeder},
}
